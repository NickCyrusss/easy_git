...
- **Git operations:** commit, create and switch branches, create tags, manual fetch from the toolbar, fast-forward-only pull, push, cherry-pick, merge, revert, soft/mixed/hard reset, clone, initialization, branch deletion, and force push with an explicit lease.
